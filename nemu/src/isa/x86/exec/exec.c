...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x10 */	IDEX(G2E, adc),IDEX(G2E, adc), IDEX(E2G, adc),IDEX(E2G, adc),
  /* 0x14 */	IDEX(I2r, adc),IDEX(I2r, adc), EMPTY, EMPTY,
  /* 0x18 */	IDEX(G2E, sbb),IDEX(G2E, sbb), IDEX(E2G, sbb),IDEX(E2G, sbb),
  /* 0x1c */	IDEX(I2r, sbb),IDEX(I2r, sbb), EMPTY, EMPTY,
  /* 0x20 */	IDEX(G2E,and), IDEX(G2E,and), IDEX(E2G,and), IDEX(E2G, and),
  /* 0x24 */	IDEX(I2r,and), IDEX(I2r,and), EMPTY, EMPTY,
  /* 0x28 */	IDEX(G2E,sub), IDEX(G2E,sub), IDEX(E2G,sub), IDEX(E2G, sub),
  ...
  /* 0x3c */	IDEX(I2r,cmp), IDEX(I2r,cmp), EMPTY, EMPTY,
  ...
  /* 0xa8 */	IDEX(I2r, test), IDEX(I2r, test), EMPTY, EMPTY,
...
/*2 byte_opcode_table */
  ...
  /* 0x74 */	IDEX(J,je), IDEX(J,jne), EMPTY, EMPTY,
  ...
  /* 0x94 */	IDEX(E2G,sete), EMPTY, EMPTY, EMPTY,
  /* 0x98 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x9c */	EMPTY, EMPTY, EMPTY, EMPTY,
  ...
  /* 0xbc */	EMPTY, EMPTY, IDEX(mov_G2E,movsx), IDEX(mov_G2E,movsx),
